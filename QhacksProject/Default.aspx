...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="mainInf">
        <div class="row">
            ...
            <%-- <object data="images/logo.svg" type="image/svg+xml" width="450" height="300" class="logoPos">
        ...
        <asp:UpdateProgress runat="server" ID="loading" AssociatedUpdatePanelID="updatPanel">
            <ProgressTemplate>
                <div class="cssload-container loadingPos">
            ...
            <ContentTemplate>
                <div class="row inOutRow">
                    ...
                    <div class="col-md-7" style="padding-left:20px;">
                        ...
                        <asp:Label runat="server" CssClass="h1Lato aspTextBox h2" ID="outLabel"></asp:Label>
                    </div>
                </div>

                <div class="col-md-5 inOutRow">
                    <asp:Label runat="server" CssClass="h1Lato aspTextBox" ID="input1"></asp:Label>
                    <br />

                    <asp:Label runat="server" CssClass="h1Lato aspTextBox" ID="input2"></asp:Label>
                    <br />
                    <asp:Label runat="server" CssClass="h1Lato aspTextBox" ID="input3"></asp:Label>
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
